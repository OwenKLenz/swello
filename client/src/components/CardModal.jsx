...
const CardModal = () => {
  ...
  const setPopover = (newPopoverState) => {
  ...
  const selectPopover = (type) => {
    switch (type) {
      case "labels":
        return <LabelsPopover onCloseClick={closePopover} />
      case "due-date":
        return <DueDatePopover onCloseClick={closePopover} />
      case "copy-card":
        return <CopyCardPopover onCloseClick={closePopover} />
    }
  }
  ...
  const updateCardProperty = (properties, callback)  => {
  ...
  return (
    <>
        ...
        <div id="modal">
          ...
          <aside className="modal-buttons">
            ...
            <ul>
              ...
              <DueDateButton setPopover={setPopover} />
              <LabelsButton setPopover={setPopover} />
            ...
            <CopyCardButton setPopover={setPopover} />
      ...
      <Popover {...popoverState}>
        {selectPopover(popoverState.type)}
      </Popover>
    </>
  );
};
